...
using VentaMap.ChatService.ViewModels;

namespace VentaMap.ChatService.Services;

public class ChatAppService(ChatDbContext db, VentaMapLookupDbContext lookupDb, IConfiguration configuration)
{
