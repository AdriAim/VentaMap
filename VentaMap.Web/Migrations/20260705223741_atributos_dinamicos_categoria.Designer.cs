...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VentaMap.Models.GeneralDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VentaMap.Models.PropertyDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VentaMap.Models.PublicationExtraAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VentaMap.Models.VehicleDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VentaMap.Models.GeneralDetail", b =>
                {
                    b.HasOne("VentaMap.Models.Publication", "Publication")
                        ...
                        .HasForeignKey("VentaMap.Models.GeneralDetail", "PublicationId")
            ...
            modelBuilder.Entity("VentaMap.Models.PropertyDetail", b =>
                {
                    b.HasOne("VentaMap.Models.Publication", "Publication")
                        ...
                        .HasForeignKey("VentaMap.Models.PropertyDetail", "PublicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("VentaMap.Models.VehicleDetail", b =>
                {
                    b.HasOne("VentaMap.Models.Publication", "Publication")
                        ...
                        .HasForeignKey("VentaMap.Models.VehicleDetail", "PublicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
