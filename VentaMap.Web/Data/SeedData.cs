...
public static class SeedData
{
    ...
    public static async Task InitializeAsync(VentaMapDbContext db)
    {
        ...
        var user = await db.Users.FirstOrDefaultAsync(x => x.Email == "demo@ventamap.local");
        if (user is null)
        {
            user = new ApplicationUser
            {
                Name = "VentaMap Demo",
                Email = "demo@ventamap.local",
                Phone = "3515550101",
    ...
    private static async Task EnsurePublicationGroupsAsync(VentaMapDbContext db)
    {
    ...
    private static async Task EnsurePublicationCategoriesAsync(VentaMapDbContext db)
    {
    ...
    private static async Task EnsurePublicationReportReasonsAsync(VentaMapDbContext db)
    {
    ...
    private static async Task EnsurePublicationCategoryFieldsAsync(VentaMapDbContext db)
    {
    ...
    private static async Task<ApplicationUser> EnsureFictionalRealEstateCompanyAsync(VentaMapDbContext db)
    {
    ...
    private static async Task<ApplicationUser> EnsureFictionalAutoCompanyAsync(VentaMapDbContext db)
    {
    ...
    private static async Task<ApplicationUser> EnsureFictionalBoatCompanyAsync(VentaMapDbContext db)
    {
    ...
    private static async Task<PublicationCategoryLookup> BuildCategoryLookupAsync(VentaMapDbContext db)
    {
    ...
    private static async Task BackfillDynamicFieldValuesAsync(VentaMapDbContext db)
    {
    ...
    private static async Task BackfillGalleryImagesAsync(VentaMapDbContext db, params int[] seededUserIds)
    {
        var publications = await db.Publications
