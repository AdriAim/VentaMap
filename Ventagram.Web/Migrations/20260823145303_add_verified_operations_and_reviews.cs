...
public partial class add_verified_operations_and_reviews : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            CREATE TABLE IF NOT EXISTS `VentagramParameters` (
                ...
                UNIQUE KEY `IX_VentagramParameters_Key` (`Key`),
                KEY `IX_VentagramParameters_UpdatedByUserId` (`UpdatedByUserId`)
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.Sql("DROP TABLE IF EXISTS `VentagramParameters`;");
    }
}
